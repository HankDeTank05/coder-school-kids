...
#HOTKEYS
ALLOW_PWRUP_HOTKEY = True
PWRUP_HOTKEY_INVINCIBILITY = pygame.K_i
PWRUP_HOTKEY_HEALTH = pygame.K_h
PWRUP_HOTKEY_SLOW_DOWN = pygame.K_s
PWRUP_HOTKEY_RANDOM = pygame.K_r
...
OBSTACLE_SPEED_TRACKING_Y = random.randint(100, 275)
OBSTACLE_SPEED_TRACKING_X = 2
...
POWERUP_SPAWN_DELAY = 15
HEALTH_BOOST_SPAWN_DELAY = 45
POWERUP_SPEED = 400
